...
public class PopUpCoachMark extends DialogFragment implements IPopUpCoachMarkPresentation, View.OnClickListener {
    ...
    private OnCouchMarkerDismissListener couchMarkerDismissListener;
    ...
    public void closeCoachMarkDialog() {
        dismiss();
        if (couchMarkerDismissListener != null) {
            couchMarkerDismissListener.onMarkerDismiss();
        }
    }
    ...
    public void setCouchMarkerDismissListener(OnCouchMarkerDismissListener couchMarkerDismissListener) {
        this.couchMarkerDismissListener = couchMarkerDismissListener;
    }

    public interface OnCouchMarkerDismissListener {
        void onMarkerDismiss();
    }
}
